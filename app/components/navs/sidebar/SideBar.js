    ...
    <Offcanvas show={openSideBar} onHide={handleClose}>
      ...
      <Offcanvas.Body className="space-y-5">
        <div className="flex">
          <input
            type="text"
            className="outline-none focus:outline-none placeholder:font-normal placeholder:text-xs placeholder:tracking-normal border border-gray-20 px-2 py-3"
            placeholder="Enter keyword"
          />
          <button className="text-center px-5 py-3 bg-blue-500 text-white">
            Search
          </button>
        </div>
