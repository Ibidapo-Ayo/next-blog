      ...
      <div className="flex w-100 flex-col space-y-4 h-auto" key={id}>
        <Link href={url} target="_blank">
          <div className="flex">
            ...
            >
              <img
                src={postImage || `https://placehold.co/600x400/000000/FFF`}
                alt=""
        ...
        <div
          className="text-md line-clamp-3 text-gray-900 dark:text-gray-50"
          dangerouslySetInnerHTML={{ __html: description }}
        />

        <div className="flex space-x-3">
          <div className="w-10 h-10 rounded-full flex justify-center items-center shrink-0">
            <img src={`https://avatar.iran.liara.run/public/${Math.floor(Math.random() * 40 ) + 1}`} alt="" className="w-10 h-10 rounded-full" />
          </div>
